...
keypad.addEventListener("click", (e)=>{
    if (e.target.classList.contains("calculator__key--0") || e.target.classList.contains("calculator__key--1") || e.target.classList.contains("calculator__key--2") || e.target.classList.contains("calculator__key--3") || e.target.classList.contains("calculator__key--4") || e.target.classList.contains("calculator__key--5") || e.target.classList.contains("calculator__key--6") || e.target.classList.contains("calculator__key--7") || e.target.classList.contains("calculator__key--8") || e.target.classList.contains("calculator__key--9") || e.target.classList.contains("calculator__key--add") || e.target.classList.contains("calculator__key--subtract") || e.target.classList.contains("calculator__key--multiply") || e.target.classList.contains("calculator__key--divide")) {
    ...
    if (e.target.classList.contains("calculator__key--equal")) {
        str += currentNum;
        currentNum = "";
        if (operants.includes(str[str.length - 1])) str = str.slice(0, -1);
